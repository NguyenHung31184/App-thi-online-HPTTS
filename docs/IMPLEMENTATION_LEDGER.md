...
3. Phase C2, single question store: step 1 (one library per module, all questions linked, QTHH-AT copies merged, auto-assign trigger) applied 2026-09-24; steps 2 and 3 (editing inside libraries, retire the old entry point) next. See `docs/implementation/2026-09-24-phase-c2-single-question-store.md`.
