-- Phase 4: grade_attempt hỗ trợ drag_drop (sắp thứ tự) và bỏ qua video_paragraph/main_idea (chấm tay)
-- Chạy sau 004.
...
COMMENT ON FUNCTION grade_attempt(UUID) IS 'Phase 4: single_choice, multiple_choice, drag_drop tự động; video_paragraph/main_idea chấm tay qua attempt_question_scores.';
